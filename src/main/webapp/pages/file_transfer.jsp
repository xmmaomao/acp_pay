...
<form class="api-form" method="post" action="<%request.getContextPath();%>/query/fileTransfer" target="_blank">
<p>
<label>商户号：</label>
<input id="merId" type="text" name="merId" placeholder="777290058150723" value="777290058150723" title="请替换实际商户号测试，自助化平台注册的商户号（777开头的）无法测试此接口，如无真实商户号，请使用700000000000001测试此接口" required="required"/>
</p>
<p>
<label>订单发送时间：</label>
