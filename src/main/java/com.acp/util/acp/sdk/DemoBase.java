...
public class DemoBase {
    ...
    public static String genHtmlResult(Map<String, String> data) {
        ...
        while (it.hasNext()) {
            ...
            } else sf.append(key + SDKConstants.EQUAL + value + "</br>");
        }
        return sf.toString();
    }
    ...
    public static List<Map> parseZMFile(String filePath) {
        int lengthArray[] = {3, 11, 11, 6, 10, 19, 12, 4, 2, 21, 2, 32, 2, 6, 10, 13, 13, 4, 15, 2, 2, 6, 2, 4, 32, 1, 21, 15, 1, 15, 32,
    ...
    public static String getFileContentTable(List<Map> dataList, String file) {
        StringBuffer tableSb = new StringBuffer("对账文件的规范参考 https://open.unionpay.com/ajweb/help/file/ 产品接口规范->平台接口规范:文件接口</br> 文件【" +
                file + "】解析后内容如下：");
