...
public class SecureUtil {
    ...
    public static byte[] signBySoft(PrivateKey privateKey, byte[] data) throws Exception {
        return myGign(privateKey, data, BC_PROV_ALGORITHM_SHA1RSA);
    }
    ...
    public static byte[] signBySoft256(PrivateKey privateKey, byte[] data) throws Exception {
        return myGign(privateKey, data, BC_PROV_ALGORITHM_SHA256RSA);
    }

    public static byte[] myGign(PrivateKey privateKey, byte[] data, String algorithm) throws Exception {
        byte[] result = null;
        Signature st = Signature.getInstance(algorithm, "BC");
